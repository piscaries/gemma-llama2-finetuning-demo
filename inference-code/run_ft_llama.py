...
base_model_name = "/path-to-llama-7b-chat-hf"
adapter_model_name = "path-to-llama-ft-checkpoint"
quantization_config = BitsAndBytesConfig(load_in_8bit=True)

t_start = time.time_ns() / 1000000
model = AutoModelForCausalLM.from_pretrained(base_model_name, local_files_only=True, device_map="auto", quantization_config=quantization_config)
